...
async function getScheduleMessage(id) {
    ...
    switch(id) {
        case "1":
            ...
            previous
            .setCustomId(`${fileName}${globals.separator}1`)
            .setLabel(`Previous`)
            .setStyle(ButtonStyle.Danger)
            .setDisabled(true);

            next
            .setCustomId(`${fileName}${globals.separator}2`)
            .setLabel(`Next`)
        ...
        case "2":
            ...
            next
            .setCustomId(`${fileName}${globals.separator}3`)
            .setLabel(`Next`)
            .setStyle(ButtonStyle.Primary);
